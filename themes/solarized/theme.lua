...
theme.layout_uselessfair       = theme.theme_icons .. "fairv.png"
theme.layout_uselessfairh      = theme.theme_icons .. "fairh.png"
theme.layout_uselesstile       = theme.theme_icons .. "tile.png"
theme.layout_uselesstileleft   = theme.theme_icons .. "tileleft.png"
theme.layout_uselesstilebottom = theme.theme_icons .. "tilebottom.png"
